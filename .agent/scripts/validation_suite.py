...
STEPS = (
    ...
    ("direct_fs_tripwire", [sys.executable, ".agent/mcp/tests/test_direct_fs_tripwire.py"]),
    ("tenor_decision", [sys.executable, ".agent/mcp/tests/test_tenor_decision.py"]),
    ("tenor_memory_admission", [sys.executable, ".agent/mcp/tests/test_tenor_memory_admission.py"]),
    ("canonical_memory_gate", [sys.executable, ".agent/mcp/tests/test_canonical_memory_gate.py"]),
    ("tenor_public_api", [sys.executable, ".agent/mcp/tests/test_tenor_public_api.py"]),
    ("generated_output_hygiene", [sys.executable, ".agent/mcp/tests/test_generated_output_hygiene.py"]),
